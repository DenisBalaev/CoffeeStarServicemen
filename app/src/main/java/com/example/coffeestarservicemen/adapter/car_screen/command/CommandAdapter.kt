...
import com.example.coffeestarservicemen.databinding.ItemBottomSheetCommandListBinding
import com.example.coffeestarservicemen.decoration.CustomItemDecorationCommandBottomSheet
    ...
    class ViewHolder(private val binding:ItemBottomSheetCommandListBinding):RecyclerView.ViewHolder(binding.root){
        ...
        init {
            binding.rvListCommand.apply {
                ...
                addItemDecoration(CustomItemDecorationCommandBottomSheet(resources.getDimensionPixelSize(R.dimen.marginTop_recyclerView_Command_BottomSheet)))
            }
        }
